...
function showPage(name) {
  ...
  async function registerDonor() {
    ...
    try {
      ...
      window.editingId = null;
      document.getElementById('registerBtn').textContent = "Register as Donor";
      clearForm();
      loadDonors();
    } 
    catch (err) {
      ...
      return `<tr>
        ...
        <td>
          ${
            ...
            ? `
              <button onclick="editDonor('${d._id}')">Edit</button>
              <button onclick="deleteDonor('${d._id}')" 
              style="background:#C0392B; margin-left:5px;">
                Delete
              </button>
            `
  ...
  window.editDonor = function(id) {
    ...
    document.getElementById('fname').value = donor.fname;
    document.getElementById('lname').value = donor.lname;
    document.getElementById('dob').value = donor.dob;
    document.getElementById('gender').value = donor.gender;
    document.getElementById('bloodtype').value = donor.blood;
    ...
    document.getElementById('lastdonate').value = donor.lastDonate;
    document.getElementById('notes').value = donor.notes;

    window.editingId = donor._id;

    showPage('donate');

    document.getElementById('registerBtn').textContent = "Update Donor";
  }
